...
MAJI-PLATFORM however we provide access to water from any quantity,from 20L which is the minimum fucntional capacity.
_____
...
- A customer is able to order any quantity of water from 20L , which is unavaiable with the current solutions.
...
```bash
https://github.com/NgwonoJeremy/maji_platform.git
```
...
├── src/
│   ├── assets/
│   ├── components/   # Resuable webpage features eg. navbar
│   ├── Pages/    
│   │   ├── admin/    # Admin Page
│   │   ├── customer/ # Customer Page
│   │   ├── vendor/   # Vendor Page
│   │   └── ...
│   ├── styles/       # Styling for various pages
